...
import 'package:flutter_wan/util/bubble_indication_painter.dart';
...
class LoginPageState extends State<LoginPage> with SingleTickerProviderStateMixin{
  ...
  TextEditingController signupNmaeController = new TextEditingController();
  ...
  Widget _buildSignUp(BuildContext context){
    ...
    Future<Null> _register() async {
      String username = signupNmaeController.text;
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: TextField(
                          ...
                          controller: signupNmaeController,
